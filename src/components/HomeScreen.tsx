...
import {
  ...
  FaSun, FaMoon, FaPiggyBank, FaMosque, FaGavel, FaFileInvoiceDollar, FaBolt, FaLandmark, FaBaby, FaFileContract, FaVideo, FaAppleAlt, FaGoogleDrive, FaIndustry,
} from 'react-icons/fa';
...
const ICON_MAP: Record<string, React.ComponentType<{ size?: number; color?: string }>> = {
  ...
  FaRulerCombined, FaMapMarkedAlt, FaBalanceScale, FaPiggyBank, FaMosque, FaGavel, FaFileInvoiceDollar, FaBolt, FaLandmark, FaBaby, FaFileContract, FaVideo, FaAppleAlt, FaGoogleDrive, FaIndustry,
};
